...
//             'Model Deployment', 'Git', 'Cloud Technologies',
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-blue-600 via-teal-500 to-cyan-400 py-16 px-4">
//       <div className="max-w-[1600px] mx-auto px-8">
//         <div className="text-center mb-12">
//           <h1 className="text-5xl font-bold text-white mb-4">
//             Choose our best courses along with Placement Support
//           </h1>
...
//               }`}
//             >
//               <div className="text-lg">Modern AI</div>
//               <div className="text-sm opacity-80">Master cutting-edge AI technologies</div>
//             </button>
//             <button
...
//               }`}
//             >
//               <div className="text-lg">Data Science with ML</div>
//               <div className="text-sm opacity-80">Beginner to job-ready data scientist</div>
//             </button>
//           </div>
//         </div>
...
//                 {/* Main Pricing Card */}
//                 <div
//                   className={`relative bg-white/95 text-gray-900 rounded-2xl p-8 border-2 transition-all duration-300 cursor-pointer ${
//                     hoveredCard === tier.id
...
//                       {tier.name}
//                     </h3>
//                     <p className="text-gray-800 text-sm mb-4">{tier.description}</p>
...
// <button
//   onClick={() =>
//     router.push(currentTrackKey === "ds" ? "/courses/data-science" : "/courses/ai-ml")
//   }
//   className="w-full py-3 rounded-lg cursor-pointer font-semibold transition-all duration-300 bg-gradient-to-r from-blue-600 to-teal-500 text-white hover:shadow-lg hover:scale-105"
// >
//   Enroll Now
// </button>
...
//                   <div className={`mt-6 pt-6 border-t border-gray-200 transition-opacity duration-300 ${
      ...
      <div className="max-w-[1600px] mx-auto px-2 md:px-8">
        <div className="text-center mb-8 md:mb-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 mb-6 md:mb-8 px-2">
            <button
              onClick={() => setSelectedTrack('ai')}
              className={`px-4 md:px-8 py-3 md:py-4 rounded-xl font-semibold transition-all duration-300 ${
                selectedTrack === 'ai'
                  ? 'bg-white text-blue-600 shadow-2xl scale-105'
                  : 'bg-white/20 text-white hover:bg-white/30'
              }`}
