            ...
            {pricingTiers.map((tier) => (
              ...
              >
                ...
                >
                  ...
                  <button
                    className={`w-full py-3 rounded-lg font-semibold transition-all duration-300 bg-gradient-to-r from-blue-600 to-teal-500 text-white hover:shadow-lg hover:scale-105`}
                  >
                    Enroll Now
                  </button>
