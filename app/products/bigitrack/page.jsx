...
export default function BigiTrackPage() {
  return (
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-20 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-teal-900 mt-20">
        ...
        >
          ...
          <p className="text-lg sm:text-2xl text-blue-100 mb-12 leading-relaxed max-w-3xl mx-auto">
            Advanced tracking and monitoring solution for your development projects.
          </p>
        </motion.div>
      </section>
      ...
      <section className="w-full py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Real-time Tracking", description: "Monitor your projects in real-time with live updates" },
              { title: "Analytics Dashboard", description: "Comprehensive analytics and reporting tools" },
              { title: "Team Collaboration", description: "Seamless collaboration features for your team" }
            ].map((feature, idx) => (
              <motion.div
                key={idx}
                initial={{ opacity: 0, y: 20 }}
