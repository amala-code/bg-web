...
// import { FiLink, FiBarChart2, FiTrendingUp } from 'react-icons/fi';
...
//                       />
//                       {/* <div className={`absolute inset-0 bg-gradient-to-br ${course.gradient} opacity-60 group-hover:opacity-40 transition-opacity`} /> */}
...
//                       />
//                       {/* <div className={`absolute inset-0 bg-gradient-to-br ${course.color} opacity-50 group-hover:opacity-30 transition-opacity`} /> */}
//                       {/* <div className="absolute top-4 left-4 text-5xl">{course.icon}</div> */}
//                     </div>
