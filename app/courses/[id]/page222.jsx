...
const courseData = {
  ...
  "modern-ai": {
    ...
    "thumbnail": "/images/courses/modern-ai-mastery-2026.jpg",
...
//         {/* Pricing Tier Selection - Original Design */}
...
//                       </div>
//                       <p className="text-purple-200 mb-4">Total Practice Questions for {currentTier.name} Tier</p>
//                       <div className="space-y-2">
//                         {currentTierContent.assessments.map((assessment, idx) => (
//                           <div key={idx} className="flex justify-between items-center bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
//                             <span className="text-sm">{assessment}</span>
//                             <FiCheckCircle className="text-yellow-300" />
//                           </div>
//                         ))}
//                       </div>
//                     </div>
...
//                     <p className="text-teal-900 font-semibold text-center">
...
//                           className="border-2 border-teal-200 rounded-xl p-5 bg-gradient-to-br from-blue-50 to-white hover:shadow-lg transition-all"
//                         >
//                           <div className="flex items-start justify-between gap-4">
//                             <div className="flex-1">
//                               <div className="flex items-center gap-3 mb-2">
//                                 <h3 className="text-lg font-bold text-blue-900">{project.name}</h3>
//                                 <span className={`${projectTypeColors[project.type]} text-white px-3 py-1 rounded-full text-xs font-bold`}>
//                                   {project.type}
//                                 </span>
//                               </div>
...
//                   </h2>
//                   <p className="text-teal-100 mb-6">Available career paths with {currentTier.name} tier completion</p>
...
//                             <p className="text-teal-200 text-sm font-semibold">{career.salary}</p>
//                           </div>
//                         </div>
//                       </motion.div>
//                     ))}
...
//                     <p className="text-teal-900 font-semibold text-center text-sm">
//                       What you'll achieve with {currentTier.name} Tier
//                     </p>
//                   </div>
...
//                 {/* Purchase Card with Dynamic Header Color */}
//                 <AnimatePresence mode="wait">
//                   <motion.div
...
//                   >
//                     {/* Dynamic Header Color Based on Tier */}
//                     <div className={`${currentHeaderColor} p-6 text-white`}>
...
//   <button className="w-full bg-gradient-to-r from-teal-600 via-blue-600 to-indigo-700 text-white py-4 rounded-xl font-bold text-lg hover:shadow-2xl hover:scale-[1.04] transition-all duration-300 mb-4">
//     Enroll Now
//   </button>
// </Link>
...
//                 {/* Skills Component - Original Design */}
//                 <motion.div
//                   initial={{ opacity: 0, y: 20 }}
//                   animate={{ opacity: 1, y: 0 }}
...
// className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 text-white text-sm font-semibold rounded-md transition-all cursor-default shadow-sm hover:shadow-md"
//                         >
//                           {skill}
//                         </motion.div>
//                       ))}
